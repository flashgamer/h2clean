...
public class Sample
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            statement.executeUpdate("create table accountsDB (username string, password string, accountType string, " +
                    "title string, firstName string, lastName string, email string, address string)");
